...
class Wpil_Base
{
    ...
    public static function addScripts($hook)
    {
        ...
        wp_register_script('wpil_admin_script', WP_INTERNAL_LINKING_PLUGIN_URL.$js_path, array('jquery', 'wpil_base64', 'wpil_tippy', 'wpil_popper'), $ver, true);
...
/*
    ...
    public static function modify_list_row_actions( $actions, $object ) {
        ...
        if(isset($actions['delete']) && Wpil_Settings::delete_inbound_internal_on_post_delete()){
